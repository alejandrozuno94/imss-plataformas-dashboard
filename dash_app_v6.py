# -*- coding: utf-8 -*-
"""
Dashboard IMSS – Plataformas Digitales (v6)
Cambios principales:
- Barras de beneficiadas / TDP más grandes (se ven todos los estados).
- Bloque Sectores:
    * Proporción de TDP por sector en pie chart.
    * Estructura salarial: salario promedio H/M por sector, pirámide salarial,
      y círculo con brecha salarial promedio (%).
- Pestaña Evolución:
    * Tablas nacionales y CDMX con:
        - Personas beneficiadas, TDP, variaciones absolutas, tasa de formalización.
        - Salario base promedio y brecha salarial promedio.
"""
        ...
        return html.Div([
            ...
            html.Div([
                html.Div([
                    ...
                    html.Div([
                        html.Div("Independientes", style={"fontSize": "16px", "marginTop": "8px"}),
                ...
                html.Div([
                    ...
                    html.Div([
                        html.Div("Beneficiadas", style={"fontSize": "16px", "textAlign": "right"}),
...
def bloque_sectores(df_sbc: pd.DataFrame, titulo: str) -> html.Div:
    ...
    fig_prop = px.pie(
        ...
        hole=0.4,
        color_discrete_sequence=[VERDE, DORADO, GUINDA, BLUE_DARK,
                                 BLUE_LIGHT, BROWN_LIGHT]
    )
    ...
    # ---- Resumen + círculo de brecha salarial promedio ----
    ...
    resumen = html.Div([
        html.Div([
            html.Div([
                ...
                html.Div(fmt_num(prop["Sector"].nunique()), style={
                    "fontSize": "24px",
                    "fontWeight": "800",
                    "color": BLUE_DARK
                })
            ...
            html.Div([
                html.Div("Brecha salarial prom. (%)",
                         style={"color": BLUE_LIGHT, "textAlign": "center",
                                "marginBottom": "4px"}),
                html.Div(f"{brecha_prom:.1f}%", style=circle_style)
            ], style={"display": "inline-block", "width": "25%"}),
        ])
    ], style=card_style)
    ...
    for _, row in df.iterrows():
        ...
        for col, val in row.items():
            ...
            if isinstance(val, (int, float)):
                ...
                # cadenas tipo "1 234" las dejamos alineadas a la derecha también
                try:
...
def layout_evolucion(df_jul: pd.DataFrame, df_ago: pd.DataFrame, df_sep: pd.DataFrame,
    ...
    # ---- Gráficas líneas (igual que antes) ----
    ...
    return html.Div([
        ...
        tabla_html(tabla_sal_nat, "Tabla nacional – Evolución de salario base y brecha salarial"),
        ...
        tabla_html(tabla_sal_cdmx, "Tabla CDMX – Evolución de salario base y brecha salarial")
    ])
